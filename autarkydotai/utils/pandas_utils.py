...
# - removed 'formatters' argument from print_table()
# - added 'colspan' argument to print_table(), to leave the choice of
#   letting the text span over multiple columns to the user's discretion
# - some refactoring, including lexicographic sorting of functions and
#   their arguments
...
def print_table(table, colspan=False, float_format=None, header_rows=None,
    ...
    float_format : one-parameter function, optional
        ...
        `float_format` argument to :meth:`pd.Dataframe.to_html` (e.g.
        `'{0:.2%}'.format` for displaying 1 as '100.00%').
    ...
    html = table.to_html(float_format=float_format)
